...
import wave
import base64
import re # Added for parsing mimeType
...
# Set up wave file to save output
def wave_file(filename, pcm_bytes, channels=1, rate=24000, sample_width=2):
...
# Functions to fetch news articles (unchanged)
def gnews_headlines():
    category = "general"
...
file_name='news.wav'
wave_file(file_name, raw_pcm_bytes, rate=sample_rate)